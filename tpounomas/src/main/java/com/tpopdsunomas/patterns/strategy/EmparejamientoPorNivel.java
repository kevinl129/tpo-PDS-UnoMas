...
public class EmparejamientoPorNivel implements IStrategyEmparejamiento{
    public void Emparejar(Partido partido){
        ...
        Cuenta jugador3 = new Cuenta(3, "Carlos", "Carlos@gmail.com", "Clave",0);
        Cuenta jugador4 = new Cuenta(4, "Ana", "Ana@gmail.com", "Clave",0);
        Cuenta jugador5 = new Cuenta(5, "Luis", "Luis@gmail.com", "Clave",11);
        Cuenta jugador6 = new Cuenta(6, "Sofia", "Sofia@gmail.com", "Clave",11);
        Cuenta jugador7 = new Cuenta(7, "Pedro", "Pedro@gmail.com", "Clave",11);
        Cuenta jugador8 = new Cuenta(8, "Laura", "Laura@gmail.com", "Clave",11);
        Cuenta jugador9 = new Cuenta(9, "Diego", "Diego@gmail.com", "Clave",21);
        Cuenta jugador10 = new Cuenta(10, "Valentina", "Valentina@gmail.com", "Clave",21);
        Cuenta jugador11 = new Cuenta(11, "Andres", "Andres@gmail.com", "Clave",21);
